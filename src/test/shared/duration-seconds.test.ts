...
describe("shared/duration parseSecondsValue", () => {
  ...
  // Regression test: same reasoning as parseDuration's equivalent test - a
  // fractional raw number (e.g. a payload override) must not reach the
  // device as a non-integer config parameter value.
